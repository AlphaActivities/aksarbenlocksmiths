          ...
          <div>
            ...
            <div className="relative overflow-hidden bg-black/80 backdrop-blur-md p-5 pt-3 pb-3 rounded-2xl shadow-xl ring-1 ring-white/10 shadow-inner backdrop-saturate-150 max-w-2xl mx-auto mt-[10px] mb-[32px] transition-all duration-1000 ease-[cubic-bezier(0.23,1,0.32,1)] animate-luxury-fade-up">
              ...
              <div className="relative z-10">
                ...
                <h2 className="text-3xl md:text-4xl font-bold mb-2 bg-gradient-to-r from-blue-900 via-blue-300 to-blue-900 bg-clip-text text-transparent bg-[length:400%_100%] bg-[position:0%_50%] animate-[text-shimmer_10s_linear_infinite] text-center">Trusted Locksmith Services in Omaha for Over 15 Years</h2>
