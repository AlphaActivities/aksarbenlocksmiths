...
export default class ErrorBoundary extends React.Component<React.PropsWithChildren, State> {
  ...
  render() {
    ...
    return (
      <div className="min-h-screen w-full grid place-items-center text-white px-6">
        <div className="max-w-xl text-center">
          ...
          <div className="flex items-center justify-center gap-3">
            <button
              onClick={(e) => {
                trackClick("error_boundary_retry_click", e.currentTarget as unknown as HTMLElement, {
