      ...
      <div className={`relative z-10 min-h-screen bg-gradient-to-br ${gradientClasses} backdrop-blur-sm px-6 py-12 pt-16 text-white`}>
        <div className="mb-6 flex items-center justify-between">
          ...
          <Link
            ...
            className="inline-flex items-center gap-2 px-5 py-2 rounded-full bg-[linear-gradient(to_left,_#7f1d1d,_#991b1b,_#ef4444,_#b91c1c,_#991b1b,_#7f1d1d)] bg-[length:800%_100%] animate-[glowPulse_3s_ease-in-out_infinite] anim-glow-pulse text-white text-sm shadow-[0_0_24px_rgba(255,255,255,0.5)] hover:brightness-125 hover:scale-105 transition duration-300 ease-in-out"
