...
export const BLOG_CATEGORIES: Record<BlogCategorySlug, {
  ...
  emergency: {
    ...
    description: 'Lockouts, urgent entry, broken keys and after-hours help in Omaha. Practical emergency locksmith guides from Aksarben Locksmiths.',
    intro:
  ...
  keys: {
    ...
    description: 'Spare keys, car key programming, high-security blanks and duplication best practices for Omaha drivers and homeowners.',
    intro:
  ...
  residential: {
    ...
    description: 'Rekey vs replace, deadbolt choices, door hardware and home security checklists tailored for Omaha neighborhoods.',
    intro:
