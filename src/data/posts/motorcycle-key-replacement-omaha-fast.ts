...
const post: BlogPost = {
  slug: "motorcycle-key-replacement-omaha-fast",
  title: "How to Replace Lost Motorcycle Keys in Omaha Fast",
  category: "keys",
  city: "Omaha",
  date: new Date().toISOString(),
  excerpt:
    "Lost your motorcycle key around Omaha? See the fastest ways to get a new key cut or programmed, what info to have ready, and how a mobile locksmith speeds things up.",
  coverImage: "/images/blog/motorcycle-key-replacement.webp",
  altText: "Locksmith holding a replacement motorcycle key next to a parked bike in Omaha",
  keywords: [
    "motorcycle key replacement Omaha",
    "motorbike key cutting Omaha",
    "motorcycle ignition key lost",
    "motorcycle transponder key",
    "mobile locksmith Omaha",
    "bike key programming",
    "Aksarben Locksmiths"
  ],
  body: `
