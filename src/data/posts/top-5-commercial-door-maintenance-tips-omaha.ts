...
const post: BlogPost = {
  slug: "top-5-commercial-door-maintenance-tips-omaha",
  title: "Top 5 Commercial Door Maintenance Tips for Omaha Businesses",
  category: "commercial",
  city: "Omaha",
  date: new Date().toISOString(),
  excerpt:
    "Keep doors working safely and smoothly. Five quick maintenance tips Omaha shops can use to avoid jams, key control headaches, and emergency lock failures.",
  coverImage: "/images/blog/commercial-door-maintenance.webp",
  altText: "Commercial aluminum storefront doors with closers at an Omaha business",
  keywords: [
    "commercial door maintenance Omaha",
    "storefront door repair",
    "panic bar maintenance",
    "door closer adjustment",
    "master key control",
    "commercial locksmith Omaha",
    "Aksarben Locksmiths"
  ],
  body: `
